...
import com.moke.dogsapp.model.DogDao;
import com.moke.dogsapp.model.DogDataBase;
import com.moke.dogsapp.model.DogsApiService;
import com.moke.dogsapp.util.SharedPreferencesHelper;
...
public class ListViewModel extends AndroidViewModel {
    ...
    public ListViewModel(@NonNull Application application) { super(application); }
    ...
    private void fetchFromRemote() {
        loading.setValue(true);
        disposable.add(
                // getDogs will return a Single it means subscribe to Single observer?? or observe??? basta
                dogsService.getDogs()
    ...
    // we don't want this task to remain in a background memory
    // we don't want to execute this if our application is destroyed
    private class InsertDogTask extends AsyncTask<List<DogBreed>, Void, List<DogBreed>> {
        ...
        // execution of foreground thread
        @Override
